...
public final class CrawljaxConfiguration {
	...
	private Map<Pattern, String> regexFilters = new HashMap<Pattern, String>();
	 ...
	 * @author Scott Yeskie
	 * 
	 * @return The ReEx filters that are applied before the DOM is used.
	 */
	 ...
	 * 
	 * @param regexMapping
	 * 			   The ReEx filters that are applied before the DOM is used.
	 */
	public void setRegexFilters(Map<Pattern, String> regexMapping) {
		this.regexFilters = regexMapping;
	}
	 ...
	 * 
	 * @param find
	 * 			The RegEx pattern (Pattern object or String) to match
	 * 			If String is used, defaults to CASE_INSENSITIVE
	 * @param replace
	 * 			The String to put in place of the pattern. Can contain RegEx matched strings.
	 * Note: resulting string should still be a valid DOM
	 */
	public void addRegexFilter(Pattern find, String replace) {
		this.regexFilters.put(find, replace);
	}
	
	public void addRegexFilter(String find, String replace) {
		this.regexFilters.put(Pattern.compile(find, Pattern.CASE_INSENSITIVE | Pattern.DOTALL), replace);
	}
