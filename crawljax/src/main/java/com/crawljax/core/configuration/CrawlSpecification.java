...
public class CrawlSpecification {
	...
	private StateVertixIdentifier stateVertixIdentifier = new StrippedDomVertixIdentifier();
	...
	public StateVertixIdentifier getStateVertixIdentifier() {
		return stateVertixIdentifier;
	}

	public void setStateVertixIdentifier(StateVertixIdentifier stateVertixIdentifier) {
		this.stateVertixIdentifier = stateVertixIdentifier;
	}
}
